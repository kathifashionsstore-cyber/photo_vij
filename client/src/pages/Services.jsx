...
export const Services = () => {
  return (
    <div className="overflow-hidden bg-brand-dark pb-20">
      <SEOHead
        title="Services"
        description="Explore Snaplica Photography services including engagement, dhoti, half saree, birthday, wedding, pre/post wedding, anniversary, retirement, maternity, graduation, corporate events, and jewellery ads."
      />
