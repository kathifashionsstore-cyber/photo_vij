...
export const ChatbotKnowledge = () => {
  const [kb, setKb] = useState({
    ...
    packages: "We offer several packages starting from ₹20,000 for events/birthdays, up to ₹1,50,000 for our elite Royal Wedding Package (candid, cinematography, drone coverage, and leather photobooks). See the Services page for details.",
